...
WebRTC.prototype.getLocalVideoContainer = function () {
    ...
    if (el && el.tagName === 'VIDEO') {
		...
		userv.setAttribute('onclick', 'showUserChat()');
		userv.innerText = USERNAME;
...
Conversation.prototype.handleRemoteStreamAdded = function (event) {
	...
	var username = online_users[online_clients.indexOf(this.id)];
    ...
    if (container) container.appendChild(vframe);
	
    //this.emit('videoAdded', el);
    this.emit('videoAdded', vframe);
};
