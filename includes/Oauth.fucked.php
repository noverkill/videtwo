...
class Oauth {
    ...
    public function validateAccessToken() { 
        ...
        */
        ...
        if(!isset($this->_access_token) || strlen($this->_access_token) == 0) {
            ...
            print "access token not found<br>";
            
            // handle oauth 1.0 flow
            if(isset($this->_request_token_url) && strlen($this->_request_token_url) > 0){
            
                print "oauth 1.0 flow<br>";
                print "request_token_url: " . $this->_request_token_url . "<br>";
                //exit;   
            ...
            } else {   // handle oauth 2.0 flow
            
                print "oauth 2.0 flow<br>";
                //exit;
                
                // authorize app
                if(!isset($_GET['state']) && !isset($_GET['code'])){

                    print "authorize app<br>";
                    exit;        
                    $this->authorize($this->_scope);
                    return false;
 ...
 protected function authorize(/*Array*/ $scope = array(), $scope_seperator = ',', $attach = null){
  ...
  if(isset($this->_request_token_url) && strlen($this->_request_token_url) > 0){
   print "build authorize url for oauth 1.0 request<br>";
